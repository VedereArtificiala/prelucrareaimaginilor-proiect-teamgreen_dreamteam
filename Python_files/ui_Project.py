...
class MainWindow(QMainWindow):
    ...
    def setupUI(self):
        ...
        self.add_face_in_database.setText(QCoreApplication.translate("MainWindow", u"Salvează o față", None))
        self.start_camera_button.setText(QCoreApplication.translate("MainWindow", u"Pornește camera", None))
    ...
    def addFaceButton(self):
        self.command_box_text.append('Debug - s-a apăsat butonul de salvare a unei fețe')
    ...
    def startCameraButton(self):
        if self.start_camera_button_control == 1:
            self.command_box_text.append('Debug - s-a apăsat butonul de pornire a camerei')
            self.start_camera_button.setText(QCoreApplication.translate("MainWindow", u"Oprește camera", None))
            ...
            self.command_box_text.append('Debug - s-a apăsat butonul de oprire a camerei')
            self.start_camera_button.setText(QCoreApplication.translate("MainWindow", u"Pornește camera", None))
            self.start_camera_button_control = 1
...
class saveFaceUI(QtWidgets.QDialog):
    def __init__(self):
        ...
        self.browse_button.setText(QCoreApplication.translate("SecondWindow", u"Caută", None))
        self.save_button.setText(QCoreApplication.translate("SecondWindow", u"Salvează", None))
        self.label.setText("")
    ...
    def saveButton(self):
        ...
        if (self.name != '')\
            ...
            self.command_box_text.append('Înainte de a salva, te rog introdu numele')

    def browseButton(self):
        self.command_box_text.append('Browse for image button clicked.')
        file_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, 'Open file', 'C:/Users/anoro/Desktop/PIM-P'
